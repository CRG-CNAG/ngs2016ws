...
[0a/d995a5] Submitted process > fastaIndex (mouse_genome_mm9-SAMtools-0.1.19)
[#0c/bdee61#] Submitted process > mapping (mouse_cns_E18_rep1-STAR-2.4.0j)
[e4/ad3136] Submitted process > mapping (mouse_cns_E18_rep2-STAR-2.4.0j)
[10/0dda21] Submitted process > mapping (mouse_cns_E14_rep1-STAR-2.4.0j)
[35/a3b3ce] Submitted process > mapping (mouse_cns_E14_rep2-STAR-2.4.0j)
...
[subs="specialchars,attributes,quotes,replacements,macros,post_replacements"]
----
ls /nfs/users/ngs00/grape/work/0c/bdee61kbd:[TAB]0ed75e20bc6b47339257eeb9//
----
